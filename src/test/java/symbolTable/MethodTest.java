...
class MethodTest {
    ...
    public void checkEqualsForOverWriteMethod(){
        ...
        Parameter parameter = new Parameter("p1",1,new Tint("int",1));
        Parameter parameter2 = new Parameter("p2",1,new Tint("int",1));
        Parameter parameter3 = new Parameter("p3",1,new Tint("int",1));
        Parameter parameter4 = new Parameter("p5",1,new TString("String",1));
